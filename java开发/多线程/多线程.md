...
4. java多线程
   ...
   3. 空间分配
      ...
      ![image-20230829103343712](./多线程.assets/image-20![image-20230829103343712](多线程.assets/image-20230829103343712.png)个进程至少有一个线程，线程是进程的一部分，所以线程也被称为轻权进程或者轻量级进程。
...
##![image-20230829152408696](多线程.assets/image-20230829152408696.png)ong timeout)
